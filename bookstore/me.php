<?php require_once('header.php'); ?>
         ...
         <div class="tm-main-content">
            <section class="row tm-item-preview tm-margin-b-xl">
               <div class="col-12">
                  <h2 class="tm-blue-text tm-margin-b-p">Jakov Filip Saboliček</h2>
               </div>
               <div class="col-md-6 col-sm-12 mb-md-0 mb-5">
                  <div class="mr-lg-5">
                     <p class="tm-margin-b-p">Student sam Visoke škole za menadžment u turizmu i informatici u Virovitici, smjer Programsko inženjerstvo. Moje radove s faksa možete vidjeti na priloženom github linku. U slobodno vrijeme se bavim atletikom. </p>
                     <p class="tm-margin-b-p">Voljan sam savladati sve potrebno za rad, kako bih brže i bolje napredovao u struci, te ukoliko je potrebno završiti sve potrebne dodatne tečajeve usavršavanja koje od mene očekujete.</p>
                  </div>
               </div>
               <div class="col-md-6 col-sm-12 tm-highlight tm-small-pad">
                  <h2 class="tm-margin-b-p">Znanje</h2>
                  <p class="tm-margin-b-p">Predmeti</p>
                  <p>Predmeti</p>
               </div>
            </section>
            <div class="row tm-margin-b-ll">
               <article class="col-12 col-sm-12 col-md-4 col-lg-4 mb-md-0 mb-5">
                  ...
                  <header class="tm-margin-b-30">
                     <h3 class="tm-blue-text tm-h3">Backend</h3>
                  </header>
                  <p>Stuff 1</p>
                  <p>Stuff 2</p>
                  <p>Stuff 3</p>
               ...
               <article class="col-12 col-sm-12 col-md-4 col-lg-4 mb-md-0 mb-5">
                  ...
                  <header class="tm-margin-b-30">
                     <h3 class="tm-blue-text tm-h3">Frontend</h3>
                  </header>
                  <p>Stuff 1</p>
                  <p>Stuff 2</p>
                  <p>Stuff 3</p>
               ...
               <article class="col-12 col-sm-12 col-md-4 col-lg-4 mb-md-0 mb-5">
                  ...
                  <header class="tm-margin-b-30">
                     <h3 class="tm-blue-text tm-h3">Stuff</h3>
                  </header>
                  <p>Stuff 1</p>
                  <p>Stuff 2</p>
                  <p>Stuff 3</p>
